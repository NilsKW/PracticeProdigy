...
window.BADGES_DATA = [
  ...
  },
  {
    ...
    name_fr: "Habitué des étirements",
    description: "Spend a total of 2 hours on the Stretching exercise.",
    description_fr: "Passez un total de 2 heures sur l'exercice Étirements.",
  },
  {
    id: "scale-complete",
    icon: "🎵",
    ...
    description: "Check off every sub-exercise of a scale exercise.",
    description_fr: "Cochez tous les sous-exercices d'une gamme.",
  },
];
